<template>
  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-gray-300">
      ...
      <a
        class="flex items-center justify-center flex-shrink-0 w-10 h-10 rounded hover:bg-gray-300"
        href="#"
      >
        <svg
          class="w-5 h-5"
    ...
    <div class="flex flex-col w-56 border-r border-gray-300">
      ...
      <div class="flex flex-col flex-grow p-4 overflow-auto">
        ...
        <RouterLink
          class="flex items-center flex-shrink-0 h-10 px-3 mt-auto text-sm font-medium bg-blue-500 rounded text-white hover:bg-gray-400"
  ...
  >
    ...
    <!-- <span class="text-sm ml-1 leading-none">@valen.vue</span> -->
  </a>
</template>
